...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "http://124.220.2.190:80/ksjsb.json",//json
...
class _0x9d8dda {
  ...
  async ["luckdrawTasksReward"](T) {
    ...
    // a['result'] == 1 ? console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励获得" + a["data"]["popUp"]["taskRewardName"]) : console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励失败：" + a["error_msg"]);
	   a['result'] == 1 ? ( a["data"]["popUp"] ? console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励获得" + a["data"]["popUp"]["taskRewardName"]) : console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励失败：" + a["error_msg"]) ) : console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励失败：" + a["error_msg"]);
  }
