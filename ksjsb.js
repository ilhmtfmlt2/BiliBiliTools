...
let _0x134a17 = new Date(),
    ...
    _0x5bc515 = "ksjsb",
    _0x180c0c = ""
    ksjsbjk = "http://121.5.155.65:8080/ks.json",
...
class _0x9d8dda {
  ...
  async ["withdraw"](T) {
    if (!this["bindAlipay"] && !this["bindWechat"]) {
      _0x1ab8b7("账号[" + this["name"] + "]未绑定账号，不执行提现");
    ...
    Q["result"] == "SUCCESS" ? _0x1ab8b7('账号' + this["index"] + '[' + this["name"] + "]" + T + '元到' + S + '[' + a + "]成功") : _0x1ab8b7('账号' + this["index"] + '[' + this["name"] + "]" + T + '元到' + S + '[' + a + "]失败：" + Q["msg"]);
  }
  ...
  async ["withdrawOverview"]() {
    ...
    if (S["result"] == 1) {
      ...
      console["log"]("账号[" + this["name"] + "]查询ks列表失败：" + S["error_msg"]);
    }
  }
  ...
  async ["bindInfo"]() {
    ...
    if (S["result"] == "SUCCESS") {
      ...
      console["log"]("账号[" + this["name"] + "]查询ks账号绑定情况失败：" + S["error_msg"]);
    }
  }
  ...
  async ['accountInfo']() {
    ...
    S["result"] == "SUCCESS" ? this["needSms"] = S["need_mobile_code"] : console["log"]("账号[" + this["name"] + "]查询账号ks情况失败：" + S["error_msg"]);
  }
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "http://121.5.155.65:8080/ks.json";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "http://121.5.155.65:8080/ks.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "http://121.5.155.65:8080/ks.json";
